...
# Asignar los nuevos nombres de columnas al data frame
...
```{r}
# Crear el objeto sample_info con la columna de condición
condition <- gsub("([A-Za-z]+)([0-9]+)([A-Za-z]*)", "\\1\\2", new_column_names[-(1:6)])
condition <- gsub("I$", "", condition)  # Quitar el sufijo 'I' si está presente

row.names = names(readcounts)

# Crear el data frame de información de muestra
sample_info <- DataFrame(condition = condition, row.names = new_column_names[-(1:6)])

# Verificar la estructura del data frame para confirmar los cambios
str(sample_info)

# Mostrar el data frame sample_info
sample_info
